							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-6">
									<div class="post-item well-block" style="border-bottom: 3px solid #6032a6">
										<div class="well-header">Reception Venues</div>
										<div class="post-img">
								...
								<div class="col-md-4 col-sm-6">
									<div class="post-item well-block" style="border-bottom: 3px solid #e545be">
										<div class="well-header">Hair and Makeup</div>
										<div class="post-img">
								...
								<div class="col-md-4 col-sm-6">
									<div class="post-item well-block" style="border-bottom: 3px solid #a232a6">
										<div class="well-header">Marriage Celebrant</div>
										<div class="post-img">
								...
								<div class="col-md-4 col-sm-6">
									<div class="post-item well-block" style="border-bottom: 3px solid #a64832">
										<div class="well-header">Videography</div>
										<div class="post-img">
								...
								<div class="col-md-4 col-sm-6">
									<div class="post-item well-block" style="border-bottom: 3px solid #fff000">
										<div class="well-header">Planners</div>
										<div class="post-img">
								...
								<div class="col-md-4 col-sm-6">
									<div class="post-item well-block" style="border-bottom: 3px solid #000">
										<div class="well-header">Photo Booth</div>
										<div class="post-img">
								...
								<div class="col-md-4 col-sm-6">
									<div class="post-item well-block" style="border-bottom: 3px solid #35a632">
										<div class="well-header">Decorations</div>
										<div class="post-img">
				...
				<aside class="l-sidebar">
					<div class="widget widget-aside widget-list">
						...
						<ul class="list">
							...
							<li><a href="">Hens Nights and Bucks Parties</a></li>
							<li><a href="">Hire</a></li>
							<li><a href="">Honeymoon</a></li>
							<li><a href="">Invitations</a></li>
							<li><a href="">Jewellery</a></li>
							<li><a href="">Lingerie</a></li>
							<li><a href="">Marriage Celebrant</a></li>
							<li><a href="">Music</a></li>
							<li><a href="">Photo Booth</a></li>
							<li><a href="">Photography</a></li>
							<li><a href="">Planners</a></li>
							<li><a href="">Reception Venues</a></li>
