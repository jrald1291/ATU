...
= 1.1 =
* Released 11/06/2011
* Upgraded plugin internals with Wordpress Widget Class, allows (i) improved admin panel, (ii) multiple tables on the sidebar, and (iii) customize header colors

= 1.0 =
* Released 25/02/2010 
* First release includes nine table formats, and over 200 currencies
