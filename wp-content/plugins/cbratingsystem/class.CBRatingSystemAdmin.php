...
class CBRatingSystemAdmin {
    ...
    public static function admin_rating_mainmenu() {
		...
		$ratingactionuserlog = add_submenu_page( 'rating', __( CB_RATINGSYSTEM_PLUGIN_NAME . ' Main' ), __( 'User Rating Logs', 'cbratingsystem' ), 'edit_posts', 'rating_reports', array( 'CBRatingSystemAdmin', 'admin_rating_reports_page' ) );
