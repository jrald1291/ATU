	...
	<div class="postbox">
		...
		<div class="inside">
			<p>Name : CBX Multi Criteria Rating System <?php echo 'v' . CB_RATINGSYSTEM_PLUGIN_VERSION; ?></p>

			<p>Author : Codeboxr Team</p>

			<p>Plugin URL :
				<a href="http://wpboxr.com/product/multi-criteria-flexible-rating-system-for-wordpress" target="_blank">wpboxr.com</a>
			</p>
	...
	if ( defined( 'CB_RATINGSYSTEM_SUPPORT_VIDEO_DISPLAY' ) ) :
		?>
		<div class="postbox">
			<h3>Video Tutorial</h3>

			<div class="inside">
				<iframe width="262" height="158" src="//www.youtube.com/embed/videoseries?list=PLwKEWsEWkI_zY8W5wQT0vPdJnDhnCO6Gq" frameborder="0" allowfullscreen></iframe>
				<p>
