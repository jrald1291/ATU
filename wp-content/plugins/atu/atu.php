...
class ATU {
    ...
    function __construct() {
        ...
        //add_action('generate_rewrite_rules', array( $this, 'wepn_add_rewrite_rule' ), 99 );

    }


    function wepn_add_rewrite_rule($wp_rewrite){
        $new_rules = $this->eg_generate_rewrite_rules( 'vendor' );
