	    ...
	    <div>
	        ...
	        <div>
	            <table class="form-table">
	                ...
	                <tr>
	                    <td colspan="3">
							<textarea class="widefat mc4wp-option" rows="6" cols="50" name="mc4wp_form_styles[form-<?php echo $form_id; ?>][manual]" id="manual-css" placeholder="Example: .mc4wp-form { background: url('http://...'); }"><?php echo esc_textarea( $styles['manual'] ); ?></textarea>
	                    </td>
	                </tr>
		            <tr valign="top">
