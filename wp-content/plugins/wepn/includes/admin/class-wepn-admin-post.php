...
//            }
        ...
        public function post_type_init() {
            ...
            $post_types = array(
                ...
                'vendor' => array(
                    'labels'             => array(
                        'name'               => _x( 'Vendors', 'post type general name', WEPN_TEXT_DOMAIN ),
                        'singular_name'      => _x( 'Vendor', 'post type singular name', WEPN_TEXT_DOMAIN ),
                        'menu_name'          => _x( 'Vendors', 'admin menu', WEPN_TEXT_DOMAIN ),
                        'name_admin_bar'     => _x( 'Vendor', 'add new on admin bar', WEPN_TEXT_DOMAIN ),
                        'add_new'            => _x( 'Add New', 'Vendor', WEPN_TEXT_DOMAIN ),
                        'add_new_item'       => __( 'Add New Vendor', WEPN_TEXT_DOMAIN ),
                        'new_item'           => __( 'New Vendor', WEPN_TEXT_DOMAIN ),
                        'edit_item'          => __( 'Edit Vendor', WEPN_TEXT_DOMAIN ),
                        'view_item'          => __( 'View Vendor', WEPN_TEXT_DOMAIN ),
                        'all_items'          => __( 'All Vendors', WEPN_TEXT_DOMAIN ),
                        'search_items'       => __( 'Search Vendors', WEPN_TEXT_DOMAIN ),
                        'parent_item_colon'  => __( 'Parent Vendors:', WEPN_TEXT_DOMAIN ),
                        'not_found'          => __( 'No Vendors found.', WEPN_TEXT_DOMAIN ),
                        'not_found_in_trash' => __( 'No Vendors found in Trash.', WEPN_TEXT_DOMAIN )
                    ),
                    'public'             => true,
                    'publicly_queryable' => true,
                    'show_ui'            => true,
