...
if ( !class_exists('WEPN_Admin_Settings') ) {
    class WEPN_Admin_Settings {
        ...
        public static function get_settings_pages() {
            if ( empty( self::$settings ) ) {
                include_once("settings/class-wepn-settings-page.php");

                self::$settings[] = include_once("settings/class-wepn-settings-general.php");
                self::$settings[] = include_once("settings/class-wepn-settings-account.php");
            }
        }
        ...
        public static function validate_code( $code ) {
            ...
            return $wpdb->get_var( "SELECT count(*) FROM ". $wpdb->prefix . WEPN_TBL_PREFIX . "registration_code WHERE code = '$code' AND is_active = 1" );
        }
        ...
        public static function set_used_reg_code( $code ) {
           ...
           $wpdb->update( $wpdb->prefix . WEPN_TBL_PREFIX . "registration_code",
               array(
                    'is_active' => 0,
        ...
        public static function output() {
            ...
            $tabs = apply_filters( 'wepn_settings_tab_array', array() );
        ...
        public static function save() {
            ...
            do_action( 'wepn_settings_save_' . $current_tab );

            self::add_message( __( 'Your settings have been saved.', WEPN_TEXT_DOMAIN ) );
        }
